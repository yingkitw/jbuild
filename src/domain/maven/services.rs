...
use super::aggregates::{MavenPlugin, MavenProject};
...
impl LifecycleExecutor {
    ...
    pub fn new() -> Self {
        ...
        phase_bindings.insert(LifecyclePhase::Test, vec!["surefire:test".to_string()]);
        phase_bindings.insert(LifecyclePhase::Package, vec!["jar:jar".to_string()]);
        phase_bindings.insert(LifecyclePhase::Install, vec!["install:install".to_string()]);
        phase_bindings.insert(LifecyclePhase::Deploy, vec!["deploy:deploy".to_string()]);
    ...
    pub fn execute_goal(&self, _project: &MavenProject, goal: &str) -> Result<()> {
    ...
    fn parse_plugin_goal(
        &self,
        goal: &str,
    ) -> Result<super::super::artifact::value_objects::ArtifactCoordinates> {
        ...
        super::super::artifact::value_objects::ArtifactCoordinates::new(group, artifact, "LATEST")
    }
}
